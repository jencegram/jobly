...
describe("findAll with filters", function () {
  ...
  test("works: by minimum employees", async function () {
  ...
  test("works: by maximum employees", async function () {
  ...
  test("works: by name and employee range", async function () {
    let companies = await Company.findAll({ name: 'C1', minEmployees: 1, maxEmployees: 10 });
    expect(companies).toEqual([
      {
        handle: "c1",
        name: "C1",
  ...
  test("bad request with invalid filters", async function () {
    try {
